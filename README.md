...
- **[DanyCDev/modrinth-collection-web-download](https://github.com/DanyCDev/modrinth-collection-web-download)** - A tool for downloading a Modrinth collection as a single .zip file, entirely from your browser.
